...
- After launching the command, tell the user: "Codex adversarial review started in the background. Read it with the `TaskOutput` tool, or list jobs with `ListAgents`."
